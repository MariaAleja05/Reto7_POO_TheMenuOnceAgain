# Reto número 7 repo POO

 ### **Fecha:** 11-09-2024

**1.** Take the Menu code from Reto 3 and implement a new Class that creates and iterable with all the items in an order, it should allow looping and contain all item attributes.

Look at the file: Reto7.py
